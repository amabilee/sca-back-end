...
router.get('/visitante/:id', authenticationMiddleware, authorizationMiddleware({nivel_acesso: 2}), VisitanteController.getEntityById, () => {/* #swagger.tags = ['Visitante'] */});

router.post('/visitante', authenticationMiddleware, authorizationMiddleware({nivel_acesso: 2}), VisitanteController.createEntity, () => {/* #swagger.tags = ['Visitante'] */});

router.post('/visitanteLogin', VisitanteController.login, () => {/* #swagger.tags = ['Visitante'] */});
